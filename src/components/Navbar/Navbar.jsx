        ...
        <>
            ...
            <div className="flex justify-around items-center">
                ...
                <div className="flex flex-row items-center ">
                    <button className='font-inter text-base font-medium tracking-normal leading-none text-center mr-3'>Logout</button>
                    <div className='flex flex-row items-center'>
                    ...
                    <div className="flex flex-row items-center ml-4">
                        ...
                        <p className='font-inter text-base font-medium tracking-normal leading-none text-center cursor-pointer'>Shopping Cart</p>
                    </div>
